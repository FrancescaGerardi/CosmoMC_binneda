...
roots = ['SFRSys_wbinned_Planck','SFRSys_wconst_Planck','SFRSys_LCDM_Planck']
...
g.export('results_plots/triplot_SFR_comparison.pdf')
g.export('/data1/martinelli/Dropbox/Projects/SNsys/triplot_SFR_comparison.pdf')
