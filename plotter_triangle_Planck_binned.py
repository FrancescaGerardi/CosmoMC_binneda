...
roots = ['SFRSys_wbinned_Planck','metalSys_wbinned_Planck','NOSys_wbinned_Planck']
...
g.export('results_plots/triplot_metalSFRnosys_Planck_wbinned.pdf')
g.export('/data1/martinelli/Dropbox/Projects/SNsys/triplot_metalSFRnosys_Planck_wbinned.pdf')
