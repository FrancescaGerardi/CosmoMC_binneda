...
roots = ['SFRSys_wbinned_Planck_JLA_BAO','metalSys_wbinned_Planck_JLA_BAO','phenoSys_wbinned_Planck_JLA_BAO','NOSys_wbinned_Planck_JLA_BAO']
#roots = ['SFRSys_wconst_Planck']
params = [u'binw1',u'binw2',u'binw3',u'binw4',u'omegam',u'H0']
colors = ['#8E001C','#FFB300','navy','black']
labels = [ 'SFR sys', 'metallicity sys', 'pheno sys', 'No sys']
#labels = ['SFR sys']
...
g.export('results_plots/triplot_Planck_JLA_BAO_wbinned.pdf')
g.export('/data1/martinelli/Dropbox/Projects/SNsys/triplot_Planck_JLA_BAO_wbinned.pdf')
