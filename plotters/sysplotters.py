...
for case in range(len(roots)):
    ...
    omegam   = [data.loc[data.parameter=='omgegam','mean'].values[0]
    #here sys pars
...
plt.savefig('results_plots/sysplot.pdf')
plt.savefig('/data1/martinelli/Dropbox/Projects/SNsys_local/sysplot.pdf')
