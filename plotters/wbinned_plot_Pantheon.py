...
rootdir = 'output/'
roots = ['NOSys_wbinned_Planck_Pantheon_BAO','SFRSys_wbinned_Planck_Pantheon_BAO','metalSys_wbinned_Planck_Pantheon_BAO','phenoSys_wbinned_Planck_Pantheon_BAO']
...
plt.savefig('results_plots/wreconstruction_Pantheon.pdf')
plt.savefig('/data1/martinelli/Dropbox/Projects/SNsys/wreconstruction_Pantheon.pdf')
