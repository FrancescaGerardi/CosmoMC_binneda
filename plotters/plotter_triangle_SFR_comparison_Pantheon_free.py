...
roots = ['SFRSys_wbinned_Planck_Pantheon_BAO_free','SFRSys_wbinned_Planck_JLA_BAO']
...
g.export('/data1/martinelli/Dropbox/Projects/SNsys/triplot_SFR_comparison_Pantheon_free.pdf')
