...
roots = ['SFRSys_wconst_Planck_Pantheon_BAO','metalSys_wconst_Planck_Pantheon_BAO','phenoSys_wconst_Planck_Pantheon_BAO','NOSys_wconst_Planck_Pantheon_BAO']
#roots = ['SFRSys_wconst_Planck']
params = [u'binw1',u'omegam',u'H0']
colors = ['#8E001C','#FFB300','navy','black']
labels = [ 'SFR sys', 'metallicity sys','phenomenological','No sys']
#labels = ['SFR sys']
...
g.export('results_plots/triplot_Planck_Pantheon_BAO_wconst.pdf')
g.export('/data1/martinelli/Dropbox/Projects/SNsys/triplot_Planck_Pantheon_BAO_wconst.pdf')
