...
roots = ['SFRSys_wbinned_Planck_Pantheon_BAO','SFRSys_wconst_Planck_Pantheon_BAO','SFRSys_LCDM_Planck_Pantheon_BAO']
...
g.export('results_plots/triplot_SFR_comparison_Pantheon.pdf')
g.export('/data1/martinelli/Dropbox/Projects/SNsys/triplot_SFR_comparison_Pantheon.pdf')
