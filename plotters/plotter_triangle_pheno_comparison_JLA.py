...
roots = ['phenoSys_wbinned_Planck_JLA_BAO','phenoSys_wconst_Planck_JLA_BAO']#,'phenoSys_LCDM_Planck_JLA_BAO']
...
g.export('results_plots/triplot_pheno_comparison_JLA.pdf')
g.export('/data1/martinelli/Dropbox/Projects/SNsys/triplot_pheno_comparison_JLA.pdf')
