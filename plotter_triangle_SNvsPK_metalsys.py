...
roots = ['metalSys_wconst','metalSys_wconst_Planck']
...
g.export('results_plots/triplot_metalsys_wconst_SNvsPlanck.pdf')
g.export('/data1/martinelli/Dropbox/Projects/SNsys/triplot_metalsys_wconst_SNvsPlanck.pdf')
