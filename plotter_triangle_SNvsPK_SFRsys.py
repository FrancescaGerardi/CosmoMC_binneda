...
roots = ['SFRSys_wconst','SFRSys_wconst_Planck']
...
g.export('results_plots/triplot_SFRsys_wconst_SNvsPlanck.pdf')
g.export('/data1/martinelli/Dropbox/Projects/SNsys/triplot_SFRsys_wconst_SNvsPlanck.pdf')
