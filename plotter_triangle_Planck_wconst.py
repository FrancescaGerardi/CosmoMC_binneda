...
roots = ['SFRSys_wconst_Planck','metalSys_wconst_Planck','NOSys_wconst_Planck']
...
g.export('results_plots/triplot_metalSFRnosys_Planck_wconst.pdf')
g.export('/data1/martinelli/Dropbox/Projects/SNsys/triplot_metalSFRnosys_Planck_wconst.pdf')
