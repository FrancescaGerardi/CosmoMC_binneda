...
roots = ['NOSys_wbinned_Planck','NOSys_wconst_Planck','NOSys_LCDM_Planck']
...
g.export('results_plots/triplot_NOsys_comparison.pdf')
g.export('/data1/martinelli/Dropbox/Projects/SNsys/triplot_NOsys_comparison.pdf')
