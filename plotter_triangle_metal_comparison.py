...
roots = ['metalSys_wbinned_Planck','metalSys_wconst_Planck','metalSys_LCDM_Planck']
...
g.export('results_plots/triplot_metallicity_comparison.pdf')
g.export('/data1/martinelli/Dropbox/Projects/SNsys/triplot_metallicity_comparison.pdf')
